...
def no_budget_pastis(seq, timer):
    write(seq, timer, 0, text='un pastis d\'iode ?', glitch=0.5, dur=2)
    timer.wait(1, 's')
    write(seq, timer, 1, text='La vie c com un tractopel', glitch=0.5, dur=2)
    timer.wait(1, 's')
    write(seq, timer, 1, font=2, text='Pa bezo1 de permit\'', glitch=0.5, dur=2)
