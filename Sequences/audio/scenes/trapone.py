...
def trapone_intro(sequencer, timer):
    ...
    sequencer.animate([vxpitchshifterport, '/strip/VxJeannotMain/AM%20pitchshifter/Pitch%20shift/unscaled'], 1, .25, 0.45, 'beat', framerate=50)
    timer.wait(1.5, 'bites')
    sequencer.send(vxpitchshifterport, '/strip/VxJeannotMain/AM%20pitchshifter/Pitch%20shift/unscaled', 1.)
