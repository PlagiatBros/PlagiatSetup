...
#    timer.wait(.75, 'bites')
    sequencer.animate([samplesmainport, '/strip/SamplesMain/AM%20pitchshifter/Pitch%20shift/unscaled'], 1, .25, 0.45, 'beat', framerate=50)
    ...
    sequencer.animate([bassmainport, '/strip/BassMain/AM%20pitchshifter/Pitch%20shift/unscaled'], 1, .25, 0.45, 'beat', framerate=50)
    timer.wait(.5, 'bites')
